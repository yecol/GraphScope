...
@FFIForeignType(
    value = "gs::ArrowProjectedFragmentMapper<int64_t,uint64_t,std::string,double>",
    factory = ArrowProjectedFragmentMapper_cxx_0x8de83af0Factory.class
)
@FFISynthetic("com.alibaba.graphscope.fragment.mapper.ArrowProjectedFragmentMapper")
public class ArrowProjectedFragmentMapper_cxx_0x8de83af0 extends FFIPointerImpl implements ArrowProjectedFragmentMapper<Long, Long, StringView, Double> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragmentMapper_cxx_0x8de83af0.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragmentMapper_cxx_0x8de83af0(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragmentMapper_cxx_0x8de83af0 that = (ArrowProjectedFragmentMapper_cxx_0x8de83af0) o;
