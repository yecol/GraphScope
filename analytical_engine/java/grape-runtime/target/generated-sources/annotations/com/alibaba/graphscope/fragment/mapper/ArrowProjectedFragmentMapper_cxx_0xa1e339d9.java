...
@FFIForeignType(
    value = "gs::ArrowProjectedFragmentMapper<int64_t,uint64_t,int64_t,std::string>",
    factory = ArrowProjectedFragmentMapper_cxx_0xa1e339d9Factory.class
)
@FFISynthetic("com.alibaba.graphscope.fragment.mapper.ArrowProjectedFragmentMapper")
public class ArrowProjectedFragmentMapper_cxx_0xa1e339d9 extends FFIPointerImpl implements ArrowProjectedFragmentMapper<Long, Long, Long, StringView> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragmentMapper_cxx_0xa1e339d9.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragmentMapper_cxx_0xa1e339d9(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragmentMapper_cxx_0xa1e339d9 that = (ArrowProjectedFragmentMapper_cxx_0xa1e339d9) o;
  ...
  @FFINameAlias("Map")
  @CXXValue
  public StdSharedPtr<ArrowProjectedFragment<Long, Long, Long, StringView>> map(
