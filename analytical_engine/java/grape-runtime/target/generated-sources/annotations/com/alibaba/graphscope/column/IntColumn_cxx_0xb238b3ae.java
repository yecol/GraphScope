...
@FFIForeignType("gs::IntColumn<gs::ArrowProjectedFragment<int64_t,uint64_t,double,int64_t>>")
...
public class IntColumn_cxx_0xb238b3ae extends FFIPointerImpl implements IntColumn<ArrowProjectedFragment<Long, Long, Double, Long>> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(IntColumn_cxx_0xb238b3ae.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public IntColumn_cxx_0xb238b3ae(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    IntColumn_cxx_0xb238b3ae that = (IntColumn_cxx_0xb238b3ae) o;
