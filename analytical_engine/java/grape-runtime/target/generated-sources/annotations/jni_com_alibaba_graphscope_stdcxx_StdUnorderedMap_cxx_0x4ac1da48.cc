...
JNIEXPORT
jlong JNICALL Java_com_alibaba_graphscope_stdcxx_StdUnorderedMap_1cxx_10x4ac1da48_nativeGet(JNIEnv*, jclass, jlong ptr, jint arg0 /* arg00 */) {
	return (jlong)((*reinterpret_cast<std::unordered_map<unsigned,uint64_t>*>(ptr))[arg0]);
}

JNIEXPORT
void JNICALL Java_com_alibaba_graphscope_stdcxx_StdUnorderedMap_1cxx_10x4ac1da48_nativeSet(JNIEnv*, jclass, jlong ptr, jint arg0 /* arg00 */, jlong arg1 /* arg11 */) {
