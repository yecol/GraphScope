...
@FFIForeignType(
    value = "gs::ArrowProjectedFragmentMapper<int64_t,uint64_t,double,int64_t>",
    factory = ArrowProjectedFragmentMapper_cxx_0x31bcc172Factory.class
)
@FFISynthetic("com.alibaba.graphscope.fragment.mapper.ArrowProjectedFragmentMapper")
public class ArrowProjectedFragmentMapper_cxx_0x31bcc172 extends FFIPointerImpl implements ArrowProjectedFragmentMapper<Long, Long, Double, Long> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragmentMapper_cxx_0x31bcc172.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragmentMapper_cxx_0x31bcc172(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragmentMapper_cxx_0x31bcc172 that = (ArrowProjectedFragmentMapper_cxx_0x31bcc172) o;
  ...
  public StdSharedPtr<ArrowProjectedFragment<Long, Long, Double, Long>> map(
      @CXXReference StdSharedPtr<ArrowFragment<Long>> arg0, int arg1, int arg2,
      @CXXReference BaseArrowArrayBuilder<Double> arg3, @CXXReference VineyardClient arg4) {
