...
@FFIForeignType(
    value = "gs::VertexArrayDefault<int32_t>",
    factory = GSVertexArray_cxx_0x2ceb3d1fFactory.class
)
...
public class GSVertexArray_cxx_0x2ceb3d1f extends FFIPointerImpl implements GSVertexArray<Integer> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(GSVertexArray_cxx_0x2ceb3d1f.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public GSVertexArray_cxx_0x2ceb3d1f(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    GSVertexArray_cxx_0x2ceb3d1f that = (GSVertexArray_cxx_0x2ceb3d1f) o;
  ...
  @CXXOperator("[]")
  @CXXReference
  public Integer get(@CXXReference @FFITypeAlias("grape::Vertex<uint64_t>") Vertex<Long> arg0) {
  ...
  @FFINameAlias("Swap")
  public void swap(@CXXReference GSVertexArray<Integer> arg0) {
