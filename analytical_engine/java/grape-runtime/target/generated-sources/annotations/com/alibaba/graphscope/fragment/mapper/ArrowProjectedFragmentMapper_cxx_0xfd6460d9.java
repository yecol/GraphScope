...
@FFIForeignType(
    value = "gs::ArrowProjectedFragmentMapper<int64_t,uint64_t,std::string,int64_t>",
    factory = ArrowProjectedFragmentMapper_cxx_0xfd6460d9Factory.class
)
@FFISynthetic("com.alibaba.graphscope.fragment.mapper.ArrowProjectedFragmentMapper")
public class ArrowProjectedFragmentMapper_cxx_0xfd6460d9 extends FFIPointerImpl implements ArrowProjectedFragmentMapper<Long, Long, StringView, Long> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragmentMapper_cxx_0xfd6460d9.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragmentMapper_cxx_0xfd6460d9(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragmentMapper_cxx_0xfd6460d9 that = (ArrowProjectedFragmentMapper_cxx_0xfd6460d9) o;
