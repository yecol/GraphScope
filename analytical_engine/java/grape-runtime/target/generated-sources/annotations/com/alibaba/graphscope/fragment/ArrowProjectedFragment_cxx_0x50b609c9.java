...
@FFIForeignType("gs::ArrowProjectedFragment<int64_t,uint64_t,int32_t,int64_t>")
@FFISynthetic("com.alibaba.graphscope.fragment.ArrowProjectedFragment")
public class ArrowProjectedFragment_cxx_0x50b609c9 extends FFIPointerImpl implements ArrowProjectedFragment<Long, Long, Integer, Long> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragment_cxx_0x50b609c9.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragment_cxx_0x50b609c9(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragment_cxx_0x50b609c9 that = (ArrowProjectedFragment_cxx_0x50b609c9) o;
  ...
  public BaseTypedArray<Long> getEdataArrayAccessor() {
    long ret$ = nativeGetEdataArrayAccessor(address); return (new com.alibaba.graphscope.ds.BaseTypedArray_cxx_0x4f771603(ret$));
  }
  ...
  @CXXValue
  public ProjectedAdjList<Long, Long> getIncomingAdjList(@CXXReference Vertex<Long> arg0) {
    long ret$ = nativeGetIncomingAdjList(address, com.alibaba.fastffi.CXXValueScope.allocate(com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0x4ca47d21.SIZE), ((com.alibaba.fastffi.FFIPointerImpl) arg0).address); return (new com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0x4ca47d21(ret$));
  }
  ...
  @CXXValue
  public ProjectedAdjList<Long, Long> getOutgoingAdjList(@CXXReference Vertex<Long> arg0) {
    long ret$ = nativeGetOutgoingAdjList(address, com.alibaba.fastffi.CXXValueScope.allocate(com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0x4ca47d21.SIZE), ((com.alibaba.fastffi.FFIPointerImpl) arg0).address); return (new com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0x4ca47d21(ret$));
  }
