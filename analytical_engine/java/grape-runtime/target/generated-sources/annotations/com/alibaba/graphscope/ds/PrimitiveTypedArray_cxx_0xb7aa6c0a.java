...
@FFIForeignType(
    value = "gs::arrow_projected_fragment_impl::TypedArray<uint64_t>",
    factory = PrimitiveTypedArray_cxx_0xb7aa6c0aFactory.class
)
...
public class PrimitiveTypedArray_cxx_0xb7aa6c0a extends BaseTypedArray_cxx_0xb7aa6c0a implements PrimitiveTypedArray<Long> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(PrimitiveTypedArray_cxx_0xb7aa6c0a.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public PrimitiveTypedArray_cxx_0xb7aa6c0a(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    PrimitiveTypedArray_cxx_0xb7aa6c0a that = (PrimitiveTypedArray_cxx_0xb7aa6c0a) o;
