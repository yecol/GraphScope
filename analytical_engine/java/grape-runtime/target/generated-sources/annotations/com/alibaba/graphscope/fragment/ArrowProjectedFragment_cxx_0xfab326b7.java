...
@FFIForeignType("gs::ArrowProjectedFragment<int64_t,uint64_t,int32_t,std::string>")
@FFISynthetic("com.alibaba.graphscope.fragment.ArrowProjectedFragment")
public class ArrowProjectedFragment_cxx_0xfab326b7 extends FFIPointerImpl implements ArrowProjectedFragment<Long, Long, Integer, StringView> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragment_cxx_0xfab326b7.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragment_cxx_0xfab326b7(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragment_cxx_0xfab326b7 that = (ArrowProjectedFragment_cxx_0xfab326b7) o;
