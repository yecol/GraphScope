...
@FFIForeignType(
    value = "grape::VertexDataContext<gs::ArrowProjectedFragment<int64_t,uint64_t,int32_t,int32_t>,int32_t>",
    factory = FFIVertexDataContext_cxx_0x70f5d0d9Factory.class
)
...
public class FFIVertexDataContext_cxx_0x70f5d0d9 extends FFIPointerImpl implements FFIVertexDataContext<ArrowProjectedFragment<Long, Long, Integer, Integer>, Integer> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(FFIVertexDataContext_cxx_0x70f5d0d9.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public FFIVertexDataContext_cxx_0x70f5d0d9(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    FFIVertexDataContext_cxx_0x70f5d0d9 that = (FFIVertexDataContext_cxx_0x70f5d0d9) o;
