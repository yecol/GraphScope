...
@FFIForeignType("gs::ArrowProjectedFragment<int64_t,uint64_t,int32_t,double>")
@FFISynthetic("com.alibaba.graphscope.fragment.ArrowProjectedFragment")
public class ArrowProjectedFragment_cxx_0x4645b400 extends FFIPointerImpl implements ArrowProjectedFragment<Long, Long, Integer, Double> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragment_cxx_0x4645b400.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragment_cxx_0x4645b400(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragment_cxx_0x4645b400 that = (ArrowProjectedFragment_cxx_0x4645b400) o;
  ...
  @CXXReference
  public BaseTypedArray<Double> getEdataArrayAccessor() {
    long ret$ = nativeGetEdataArrayAccessor(address); return (new com.alibaba.graphscope.ds.BaseTypedArray_cxx_0x2d753886(ret$));
  }
  ...
  @CXXValue
  public ProjectedAdjList<Long, Double> getIncomingAdjList(@CXXReference Vertex<Long> arg0) {
    long ret$ = nativeGetIncomingAdjList(address, com.alibaba.fastffi.CXXValueScope.allocate(com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0xf38f75a8.SIZE), ((com.alibaba.fastffi.FFIPointerImpl) arg0).address); return (new com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0xf38f75a8(ret$));
  }
  ...
  @CXXValue
  public ProjectedAdjList<Long, Double> getOutgoingAdjList(@CXXReference Vertex<Long> arg0) {
    long ret$ = nativeGetOutgoingAdjList(address, com.alibaba.fastffi.CXXValueScope.allocate(com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0xf38f75a8.SIZE), ((com.alibaba.fastffi.FFIPointerImpl) arg0).address); return (new com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0xf38f75a8(ret$));
  }
  ...
  @CXXReference
  public BaseTypedArray<Integer> getVdataArrayAccessor() {
    long ret$ = nativeGetVdataArrayAccessor(address); return (new com.alibaba.graphscope.ds.BaseTypedArray_cxx_0x4f4be6c2(ret$));
  }
