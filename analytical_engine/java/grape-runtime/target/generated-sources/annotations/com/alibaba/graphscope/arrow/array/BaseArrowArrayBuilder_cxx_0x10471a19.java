...
@FFIForeignType(
    value = "gs::ArrowArrayBuilder<int64_t>",
    factory = BaseArrowArrayBuilder_cxx_0x10471a19Factory.class
)
@FFISynthetic("com.alibaba.graphscope.arrow.array.BaseArrowArrayBuilder")
public class BaseArrowArrayBuilder_cxx_0x10471a19 extends FFIPointerImpl implements BaseArrowArrayBuilder<Long> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(BaseArrowArrayBuilder_cxx_0x10471a19.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public BaseArrowArrayBuilder_cxx_0x10471a19(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    BaseArrowArrayBuilder_cxx_0x10471a19 that = (BaseArrowArrayBuilder_cxx_0x10471a19) o;
