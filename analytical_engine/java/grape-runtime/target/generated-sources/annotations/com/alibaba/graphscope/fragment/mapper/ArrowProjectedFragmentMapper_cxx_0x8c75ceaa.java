...
@FFIForeignType(
    value = "gs::ArrowProjectedFragmentMapper<int64_t,uint64_t,int64_t,int32_t>",
    factory = ArrowProjectedFragmentMapper_cxx_0x8c75ceaaFactory.class
)
@FFISynthetic("com.alibaba.graphscope.fragment.mapper.ArrowProjectedFragmentMapper")
public class ArrowProjectedFragmentMapper_cxx_0x8c75ceaa extends FFIPointerImpl implements ArrowProjectedFragmentMapper<Long, Long, Long, Integer> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragmentMapper_cxx_0x8c75ceaa.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragmentMapper_cxx_0x8c75ceaa(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragmentMapper_cxx_0x8c75ceaa that = (ArrowProjectedFragmentMapper_cxx_0x8c75ceaa) o;
  ...
  public StdSharedPtr<ArrowProjectedFragment<Long, Long, Long, Integer>> map(
      @CXXReference StdSharedPtr<ArrowFragment<Long>> arg0, int arg1, int arg2,
      @CXXReference BaseArrowArrayBuilder<Long> arg3, @CXXReference VineyardClient arg4) {
