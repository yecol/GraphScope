...
@FFIForeignType("gs::arrow_projected_fragment_impl::NbrDefault<uint64_t,int64_t>")
...
public class ProjectedNbr_cxx_0xd3a88ee8 extends FFIPointerImpl implements ProjectedNbr<Long, Long> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ProjectedNbr_cxx_0xd3a88ee8.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ProjectedNbr_cxx_0xd3a88ee8(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ProjectedNbr_cxx_0xd3a88ee8 that = (ProjectedNbr_cxx_0xd3a88ee8) o;
  ...
  public ProjectedNbr<Long, Long> dec() {
    long ret$ = nativeDec(address); return (new com.alibaba.graphscope.ds.ProjectedNbr_cxx_0xd3a88ee8(ret$));
  }
  ...
  @CXXOperator("==")
  public boolean eq(@CXXReference ProjectedNbr<Long, Long> arg0) {
  ...
  public ProjectedNbr<Long, Long> inc() {
    long ret$ = nativeInc(address); return (new com.alibaba.graphscope.ds.ProjectedNbr_cxx_0xd3a88ee8(ret$));
  }
