...
@FFIForeignType("gs::LongColumn<gs::ArrowProjectedFragment<int64_t,uint64_t,double,int64_t>>")
@FFISynthetic("com.alibaba.graphscope.column.LongColumn")
public class LongColumn_cxx_0xe1bc46e9 extends FFIPointerImpl implements LongColumn<ArrowProjectedFragment<Long, Long, Double, Long>> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(LongColumn_cxx_0xe1bc46e9.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public LongColumn_cxx_0xe1bc46e9(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    LongColumn_cxx_0xe1bc46e9 that = (LongColumn_cxx_0xe1bc46e9) o;
