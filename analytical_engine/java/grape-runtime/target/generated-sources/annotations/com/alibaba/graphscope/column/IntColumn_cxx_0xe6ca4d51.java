...
@FFIForeignType("gs::IntColumn<gs::ArrowProjectedFragment<int64_t,uint64_t,int64_t,int64_t>>")
...
public class IntColumn_cxx_0xe6ca4d51 extends FFIPointerImpl implements IntColumn<ArrowProjectedFragment<Long, Long, Long, Long>> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(IntColumn_cxx_0xe6ca4d51.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public IntColumn_cxx_0xe6ca4d51(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    IntColumn_cxx_0xe6ca4d51 that = (IntColumn_cxx_0xe6ca4d51) o;
