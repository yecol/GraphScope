...
@FFIForeignType(
    ...
    factory = BaseArrowArrayBuilder_cxx_0x10daeab4Factory.class
)
@FFISynthetic("com.alibaba.graphscope.arrow.array.BaseArrowArrayBuilder")
public class BaseArrowArrayBuilder_cxx_0x10daeab4 extends FFIPointerImpl implements BaseArrowArrayBuilder<Long> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(BaseArrowArrayBuilder_cxx_0x10daeab4.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public BaseArrowArrayBuilder_cxx_0x10daeab4(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    BaseArrowArrayBuilder_cxx_0x10daeab4 that = (BaseArrowArrayBuilder_cxx_0x10daeab4) o;
