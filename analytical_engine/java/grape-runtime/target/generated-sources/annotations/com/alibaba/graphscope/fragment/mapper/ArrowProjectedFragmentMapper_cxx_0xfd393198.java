...
@FFIForeignType(
    value = "gs::ArrowProjectedFragmentMapper<int64_t,uint64_t,std::string,int32_t>",
    factory = ArrowProjectedFragmentMapper_cxx_0xfd393198Factory.class
)
@FFISynthetic("com.alibaba.graphscope.fragment.mapper.ArrowProjectedFragmentMapper")
public class ArrowProjectedFragmentMapper_cxx_0xfd393198 extends FFIPointerImpl implements ArrowProjectedFragmentMapper<Long, Long, StringView, Integer> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragmentMapper_cxx_0xfd393198.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragmentMapper_cxx_0xfd393198(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragmentMapper_cxx_0xfd393198 that = (ArrowProjectedFragmentMapper_cxx_0xfd393198) o;
  ...
  @FFINameAlias("Map")
  @CXXValue
  public StdSharedPtr<ArrowProjectedFragment<Long, Long, StringView, Integer>> map(
      @CXXReference StdSharedPtr<ArrowFragment<Long>> arg0, int arg1, int arg2,
      @CXXReference BaseArrowArrayBuilder<StringView> arg3,
      @CXXReference BaseArrowArrayBuilder<Integer> arg4, @CXXReference VineyardClient arg5) {
    long ret$ = nativeMap0(address, com.alibaba.fastffi.CXXValueScope.allocate(com.alibaba.graphscope.stdcxx.StdSharedPtr_cxx_0x33e4cd62.SIZE), ((com.alibaba.fastffi.FFIPointerImpl) arg0).address, arg1, arg2, ((com.alibaba.fastffi.FFIPointerImpl) arg3).address, ((com.alibaba.fastffi.FFIPointerImpl) arg4).address, ((com.alibaba.fastffi.FFIPointerImpl) arg5).address); return (new com.alibaba.graphscope.stdcxx.StdSharedPtr_cxx_0x33e4cd62(ret$));
  }
  ...
  public StdSharedPtr<ArrowProjectedFragment<Long, Long, StringView, Integer>> map(
      @CXXReference StdSharedPtr<ArrowFragment<Long>> arg0, int arg1, int arg2,
      @CXXReference BaseArrowArrayBuilder<StringView> arg3, @CXXReference VineyardClient arg4) {
