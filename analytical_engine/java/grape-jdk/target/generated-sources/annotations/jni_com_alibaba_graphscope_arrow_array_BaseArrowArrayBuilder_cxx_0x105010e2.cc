...
JNIEXPORT
jlong JNICALL Java_com_alibaba_graphscope_arrow_array_BaseArrowArrayBuilder_1cxx_10x105010e2_nativeReserve(JNIEnv*, jclass, jlong ptr, jlong rv_base, jlong arg0 /* additionalCapacity0 */) {
