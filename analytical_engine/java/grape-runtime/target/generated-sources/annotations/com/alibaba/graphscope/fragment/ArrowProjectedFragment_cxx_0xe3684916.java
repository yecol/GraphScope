...
@FFIForeignType("gs::ArrowProjectedFragment<int64_t,uint64_t,double,double>")
@FFISynthetic("com.alibaba.graphscope.fragment.ArrowProjectedFragment")
public class ArrowProjectedFragment_cxx_0xe3684916 extends FFIPointerImpl implements ArrowProjectedFragment<Long, Long, Double, Double> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragment_cxx_0xe3684916.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragment_cxx_0xe3684916(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragment_cxx_0xe3684916 that = (ArrowProjectedFragment_cxx_0xe3684916) o;
  ...
  @CXXReference
  public BaseTypedArray<Double> getVdataArrayAccessor() {
    long ret$ = nativeGetVdataArrayAccessor(address); return (new com.alibaba.graphscope.ds.BaseTypedArray_cxx_0x2d753886(ret$));
  }
