...
@FFIForeignType("gs::ArrowProjectedFragment<int64_t,uint64_t,std::string,double>")
@FFISynthetic("com.alibaba.graphscope.fragment.ArrowProjectedFragment")
public class ArrowProjectedFragment_cxx_0x3384a871 extends FFIPointerImpl implements ArrowProjectedFragment<Long, Long, StringView, Double> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragment_cxx_0x3384a871.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragment_cxx_0x3384a871(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragment_cxx_0x3384a871 that = (ArrowProjectedFragment_cxx_0x3384a871) o;
