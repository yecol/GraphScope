...
@FFIForeignType(
    value = "gs::ArrowProjectedFragmentMapper<int64_t,uint64_t,int32_t,int32_t>",
    factory = ArrowProjectedFragmentMapper_cxx_0xb1897069Factory.class
)
@FFISynthetic("com.alibaba.graphscope.fragment.mapper.ArrowProjectedFragmentMapper")
public class ArrowProjectedFragmentMapper_cxx_0xb1897069 extends FFIPointerImpl implements ArrowProjectedFragmentMapper<Long, Long, Integer, Integer> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragmentMapper_cxx_0xb1897069.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragmentMapper_cxx_0xb1897069(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragmentMapper_cxx_0xb1897069 that = (ArrowProjectedFragmentMapper_cxx_0xb1897069) o;
  ...
  @FFINameAlias("Map")
  @CXXValue
  public StdSharedPtr<ArrowProjectedFragment<Long, Long, Integer, Integer>> map(
