...
public class StdUnorderedMap_cxx_0x4ac1da48 extends FFIPointerImpl implements StdUnorderedMap<Integer, Long> {
  ...
  @CXXReference
  @CXXOperator("[]")
  public Long get(@CXXReference Integer arg0) {
    return new java.lang.Long(nativeGet(address, arg0));
  }

  @CXXReference
  @CXXOperator("[]")
  public static native long nativeGet(long ptr, int arg00);

  @CXXOperator("[]")
  public void set(@CXXReference Integer arg0, @CXXReference Long arg1) {
    nativeSet(address, arg0, arg1);
  }

  @CXXOperator("[]")
  public static native void nativeSet(long ptr, int arg00, long arg11);
