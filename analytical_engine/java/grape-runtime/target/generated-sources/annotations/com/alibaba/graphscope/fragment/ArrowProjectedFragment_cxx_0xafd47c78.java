...
@FFIForeignType("gs::ArrowProjectedFragment<int64_t,uint64_t,int64_t,std::string>")
@FFISynthetic("com.alibaba.graphscope.fragment.ArrowProjectedFragment")
public class ArrowProjectedFragment_cxx_0xafd47c78 extends FFIPointerImpl implements ArrowProjectedFragment<Long, Long, Long, StringView> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragment_cxx_0xafd47c78.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragment_cxx_0xafd47c78(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragment_cxx_0xafd47c78 that = (ArrowProjectedFragment_cxx_0xafd47c78) o;
