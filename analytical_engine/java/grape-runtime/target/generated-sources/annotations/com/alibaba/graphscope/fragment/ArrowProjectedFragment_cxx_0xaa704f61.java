...
@FFIForeignType("gs::ArrowProjectedFragment<int64_t,uint64_t,double,std::string>")
@FFISynthetic("com.alibaba.graphscope.fragment.ArrowProjectedFragment")
public class ArrowProjectedFragment_cxx_0xaa704f61 extends FFIPointerImpl implements ArrowProjectedFragment<Long, Long, Double, StringView> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragment_cxx_0xaa704f61.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragment_cxx_0xaa704f61(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragment_cxx_0xaa704f61 that = (ArrowProjectedFragment_cxx_0xaa704f61) o;
