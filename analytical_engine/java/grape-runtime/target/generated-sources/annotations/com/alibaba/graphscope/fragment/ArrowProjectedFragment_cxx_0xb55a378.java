...
@FFIForeignType("gs::ArrowProjectedFragment<int64_t,uint64_t,std::string,int64_t>")
@FFISynthetic("com.alibaba.graphscope.fragment.ArrowProjectedFragment")
public class ArrowProjectedFragment_cxx_0xb55a378 extends FFIPointerImpl implements ArrowProjectedFragment<Long, Long, StringView, Long> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragment_cxx_0xb55a378.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragment_cxx_0xb55a378(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragment_cxx_0xb55a378 that = (ArrowProjectedFragment_cxx_0xb55a378) o;
