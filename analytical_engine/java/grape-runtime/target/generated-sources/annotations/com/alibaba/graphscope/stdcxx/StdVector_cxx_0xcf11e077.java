...
@FFIForeignType(
    ...
    factory = StdVector_cxx_0xcf11e077Factory.class
)
@FFISynthetic("com.alibaba.graphscope.stdcxx.StdVector")
public class StdVector_cxx_0xcf11e077 extends FFIPointerImpl implements StdVector<Double> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(StdVector_cxx_0xcf11e077.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public StdVector_cxx_0xcf11e077(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    StdVector_cxx_0xcf11e077 that = (StdVector_cxx_0xcf11e077) o;
  ...
  public void push_back(@CXXValue Double arg0) {
    nativePush_back(address, arg0);
  }

  public static native void nativePush_back(long ptr, double arg00);
