...
@FFIForeignType(
    value = "std::vector<gs::VertexArrayDefault<double>>",
    factory = StdVector_cxx_0x8cbe72bfFactory.class
)
@FFISynthetic("com.alibaba.graphscope.stdcxx.StdVector")
public class StdVector_cxx_0x8cbe72bf extends FFIPointerImpl implements StdVector<GSVertexArray<Double>> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(StdVector_cxx_0x8cbe72bf.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public StdVector_cxx_0x8cbe72bf(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    StdVector_cxx_0x8cbe72bf that = (StdVector_cxx_0x8cbe72bf) o;
  ...
  @CXXOperator("[]")
  @CXXReference
  public GSVertexArray<Double> get(long arg0) {
    long ret$ = nativeGet(address, arg0); return (new com.alibaba.graphscope.ds.GSVertexArray_cxx_0x13932289(ret$));
  }
  ...
  public void push_back(@CXXValue GSVertexArray<Double> arg0) {
  ...
  @CXXOperator("[]")
  public void set(long arg0, @CXXReference GSVertexArray<Double> arg1) {
