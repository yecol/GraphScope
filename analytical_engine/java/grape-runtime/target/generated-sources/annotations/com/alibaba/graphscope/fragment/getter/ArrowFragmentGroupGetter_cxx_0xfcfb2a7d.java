...
@FFISynthetic("com.alibaba.graphscope.fragment.getter.ArrowFragmentGroupGetter")
public class ArrowFragmentGroupGetter_cxx_0xfcfb2a7d extends FFIPointerImpl implements ArrowFragmentGroupGetter {
  ...
  public StdSharedPtr<ArrowFragmentGroup> get(@CXXReference VineyardClient arg0, long arg1) {
    long ret$ = nativeGet(address, com.alibaba.fastffi.CXXValueScope.allocate(com.alibaba.graphscope.stdcxx.StdSharedPtr_cxx_0xf86281af.SIZE), ((com.alibaba.fastffi.FFIPointerImpl) arg0).address, arg1); return (new com.alibaba.graphscope.stdcxx.StdSharedPtr_cxx_0xf86281af(ret$));
  }
