...
@FFIForeignType("gs::ArrowProjectedFragment<int64_t,uint64_t,double,int32_t>")
@FFISynthetic("com.alibaba.graphscope.fragment.ArrowProjectedFragment")
public class ArrowProjectedFragment_cxx_0x57bae832 extends FFIPointerImpl implements ArrowProjectedFragment<Long, Long, Double, Integer> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragment_cxx_0x57bae832.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragment_cxx_0x57bae832(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragment_cxx_0x57bae832 that = (ArrowProjectedFragment_cxx_0x57bae832) o;
