...
public class StringTypedArray_cxx_0x5d3f85f1 extends BaseTypedArray_cxx_0x5e84f3cc implements StringTypedArray {
  ...
  @CXXOperator("[]")
  @CXXValue
  public StringView get(long arg0) {
    long ret$ = nativeGet(address, com.alibaba.fastffi.CXXValueScope.allocate(com.alibaba.graphscope.ds.StringView_cxx_0xfff9df39.SIZE), arg0); return (new com.alibaba.graphscope.ds.StringView_cxx_0xfff9df39(ret$));
  }

  @CXXOperator("[]")
  @CXXValue
  public static native long nativeGet(long ptr, long rv_base, long arg00);
