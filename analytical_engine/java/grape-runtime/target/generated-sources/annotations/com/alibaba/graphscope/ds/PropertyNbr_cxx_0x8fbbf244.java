...
@FFIForeignType(
    value = "gs::NbrDefault<uint64_t>",
    factory = PropertyNbr_cxx_0x8fbbf244Factory.class
)
...
public class PropertyNbr_cxx_0x8fbbf244 extends FFIPointerImpl implements PropertyNbr<Long> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(PropertyNbr_cxx_0x8fbbf244.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public PropertyNbr_cxx_0x8fbbf244(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    PropertyNbr_cxx_0x8fbbf244 that = (PropertyNbr_cxx_0x8fbbf244) o;
  ...
  public PropertyNbr<Long> add(long arg0) {
    return new PropertyNbr_cxx_0x8fbbf244(this.address + arg0);
  }
  ...
  public PropertyNbr<Long> dec() {
    long ret$ = nativeDec(address); return (new com.alibaba.graphscope.ds.PropertyNbr_cxx_0x8fbbf244(ret$));
  }
  ...
  @CXXOperator("==")
  public boolean eq(@CXXReference PropertyNbr<Long> arg0) {
  ...
  public PropertyNbr<Long> inc() {
    long ret$ = nativeInc(address); return (new com.alibaba.graphscope.ds.PropertyNbr_cxx_0x8fbbf244(ret$));
  }
  ...
  public PropertyNbr<Long> moveTo(long arg0) {
    return new PropertyNbr_cxx_0x8fbbf244(arg0);
  }
