...
@FFIForeignType(
    value = "gs::ArrowProjectedFragmentMapper<int64_t,uint64_t,int64_t,double>",
    factory = ArrowProjectedFragmentMapper_cxx_0x60fab39eFactory.class
)
@FFISynthetic("com.alibaba.graphscope.fragment.mapper.ArrowProjectedFragmentMapper")
public class ArrowProjectedFragmentMapper_cxx_0x60fab39e extends FFIPointerImpl implements ArrowProjectedFragmentMapper<Long, Long, Long, Double> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragmentMapper_cxx_0x60fab39e.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragmentMapper_cxx_0x60fab39e(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragmentMapper_cxx_0x60fab39e that = (ArrowProjectedFragmentMapper_cxx_0x60fab39e) o;
  ...
  @FFINameAlias("Map")
  @CXXValue
  public StdSharedPtr<ArrowProjectedFragment<Long, Long, Long, Double>> map(
