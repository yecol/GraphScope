...
@FFIForeignType(
    value = "gs::JavaVertexArray<uint64_t,double>",
    factory = VertexArray_cxx_0xbe45efc3Factory.class
)
...
public class VertexArray_cxx_0xbe45efc3 extends FFIPointerImpl implements VertexArray<Long, Double> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(VertexArray_cxx_0xbe45efc3.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public VertexArray_cxx_0xbe45efc3(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    VertexArray_cxx_0xbe45efc3 that = (VertexArray_cxx_0xbe45efc3) o;
  ...
  @CXXOperator("[]")
  @CXXReference
  public Double get(@CXXReference Vertex<Long> arg0) {
  ...
  @FFINameAlias("Init")
  public void init(@CXXReference VertexRange<Long> arg0, @CXXReference Double arg1) {
  ...
  public void setValue(@CXXReference Vertex<Long> arg0, @CXXReference Double arg1) {
  ...
  @FFINameAlias("SetValue")
  public void setValue(@CXXReference VertexRange<Long> arg0, @CXXReference Double arg1) {
