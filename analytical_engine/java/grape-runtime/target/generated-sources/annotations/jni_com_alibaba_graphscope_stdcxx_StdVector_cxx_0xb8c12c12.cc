...
JNIEXPORT
jbyte JNICALL Java_com_alibaba_graphscope_stdcxx_StdVector_1cxx_10xb8c12c12_nativeGet(JNIEnv*, jclass, jlong ptr, jlong arg0 /* arg00 */) {
	return (jbyte)((*reinterpret_cast<std::vector<char>*>(ptr))[arg0]);
}

JNIEXPORT
void JNICALL Java_com_alibaba_graphscope_stdcxx_StdVector_1cxx_10xb8c12c12_nativePush_1back(JNIEnv*, jclass, jlong ptr, jbyte arg0 /* arg00 */) {
	reinterpret_cast<std::vector<char>*>(ptr)->push_back(arg0);
}

JNIEXPORT
void JNICALL Java_com_alibaba_graphscope_stdcxx_StdVector_1cxx_10xb8c12c12_nativeReserve(JNIEnv*, jclass, jlong ptr, jlong arg0 /* arg00 */) {
	reinterpret_cast<std::vector<char>*>(ptr)->reserve(arg0);
}

JNIEXPORT
void JNICALL Java_com_alibaba_graphscope_stdcxx_StdVector_1cxx_10xb8c12c12_nativeResize(JNIEnv*, jclass, jlong ptr, jlong arg0 /* arg00 */) {
	reinterpret_cast<std::vector<char>*>(ptr)->resize(arg0);
}

JNIEXPORT
void JNICALL Java_com_alibaba_graphscope_stdcxx_StdVector_1cxx_10xb8c12c12_nativeSet(JNIEnv*, jclass, jlong ptr, jlong arg0 /* arg00 */, jbyte arg1 /* arg11 */) {
