...
@FFIForeignType(
    value = "gs::ArrowProjectedFragmentMapper<int64_t,uint64_t,int64_t,int64_t>",
    factory = ArrowProjectedFragmentMapper_cxx_0x8ca0fdebFactory.class
)
@FFISynthetic("com.alibaba.graphscope.fragment.mapper.ArrowProjectedFragmentMapper")
public class ArrowProjectedFragmentMapper_cxx_0x8ca0fdeb extends FFIPointerImpl implements ArrowProjectedFragmentMapper<Long, Long, Long, Long> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragmentMapper_cxx_0x8ca0fdeb.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragmentMapper_cxx_0x8ca0fdeb(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragmentMapper_cxx_0x8ca0fdeb that = (ArrowProjectedFragmentMapper_cxx_0x8ca0fdeb) o;
  ...
  @FFINameAlias("Map")
  @CXXValue
  public StdSharedPtr<ArrowProjectedFragment<Long, Long, Long, Long>> map(
