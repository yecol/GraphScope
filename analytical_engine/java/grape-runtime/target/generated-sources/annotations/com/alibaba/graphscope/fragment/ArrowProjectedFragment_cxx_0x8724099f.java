...
@FFIForeignType("gs::ArrowProjectedFragment<int64_t,uint64_t,int64_t,double>")
@FFISynthetic("com.alibaba.graphscope.fragment.ArrowProjectedFragment")
public class ArrowProjectedFragment_cxx_0x8724099f extends FFIPointerImpl implements ArrowProjectedFragment<Long, Long, Long, Double> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragment_cxx_0x8724099f.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragment_cxx_0x8724099f(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragment_cxx_0x8724099f that = (ArrowProjectedFragment_cxx_0x8724099f) o;
  ...
  public BaseTypedArray<Long> getVdataArrayAccessor() {
    long ret$ = nativeGetVdataArrayAccessor(address); return (new com.alibaba.graphscope.ds.BaseTypedArray_cxx_0x4f771603(ret$));
  }
