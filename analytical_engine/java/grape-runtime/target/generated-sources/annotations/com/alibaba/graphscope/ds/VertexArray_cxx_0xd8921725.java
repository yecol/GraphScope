...
@FFIForeignType(
    value = "gs::JavaVertexArray<uint64_t,int32_t>",
    factory = VertexArray_cxx_0xd8921725Factory.class
)
...
public class VertexArray_cxx_0xd8921725 extends FFIPointerImpl implements VertexArray<Long, Integer> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(VertexArray_cxx_0xd8921725.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public VertexArray_cxx_0xd8921725(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    VertexArray_cxx_0xd8921725 that = (VertexArray_cxx_0xd8921725) o;
  ...
  @CXXOperator("[]")
  @CXXReference
  public Integer get(@CXXReference Vertex<Long> arg0) {
  ...
  @FFINameAlias("Init")
  public void init(@CXXReference VertexRange<Long> arg0, @CXXReference Integer arg1) {
    nativeInit1(address, ((com.alibaba.fastffi.FFIPointerImpl) arg0).address, arg1);
  }

  @FFINameAlias("Init")
  public static native void nativeInit1(long ptr, long arg00, int arg11);

  @FFINameAlias("SetValue")
  public void setValue(@CXXReference Vertex<Long> arg0, @CXXReference Integer arg1) {
    nativeSetValue0(address, ((com.alibaba.fastffi.FFIPointerImpl) arg0).address, arg1);
  }

  @FFINameAlias("SetValue")
  public static native void nativeSetValue0(long ptr, long arg00, int arg11);

  @FFINameAlias("SetValue")
  public void setValue(@CXXReference VertexRange<Long> arg0, @CXXReference Integer arg1) {
    nativeSetValue1(address, ((com.alibaba.fastffi.FFIPointerImpl) arg0).address, arg1);
  }

  @FFINameAlias("SetValue")
  public static native void nativeSetValue1(long ptr, long arg00, int arg11);

  @FFINameAlias("SetValue")
  public void setValue(@CXXReference Integer arg0) {
    nativeSetValue2(address, arg0);
  }

  @FFINameAlias("SetValue")
  public static native void nativeSetValue2(long ptr, int arg00);
