...
@FFIForeignType("gs::GraphXRawData<int64_t,uint64_t,int64_t,int64_t>")
@FFISynthetic("com.alibaba.graphscope.graphx.GraphXRawData")
public class GraphXRawData_cxx_0x78c6729b extends FFIPointerImpl implements GraphXRawData<Long, Long, Long, Long> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(GraphXRawData_cxx_0x78c6729b.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public GraphXRawData_cxx_0x78c6729b(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    GraphXRawData_cxx_0x78c6729b that = (GraphXRawData_cxx_0x78c6729b) o;
