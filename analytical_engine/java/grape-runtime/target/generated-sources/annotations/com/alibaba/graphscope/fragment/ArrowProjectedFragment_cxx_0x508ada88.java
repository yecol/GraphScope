...
@FFIForeignType("gs::ArrowProjectedFragment<int64_t,uint64_t,int32_t,int32_t>")
@FFISynthetic("com.alibaba.graphscope.fragment.ArrowProjectedFragment")
public class ArrowProjectedFragment_cxx_0x508ada88 extends FFIPointerImpl implements ArrowProjectedFragment<Long, Long, Integer, Integer> {
  ...
  static {
    try {
      ...
      System.load(FFITypeFactory.findNativeLibrary(ArrowProjectedFragment_cxx_0x508ada88.class, "grape-jni"));
    }
  }
  static {
    SIZE = _elementSize$$$();
  ...
  public ArrowProjectedFragment_cxx_0x508ada88(final long address) {
    super(address);
  }
  ...
  public boolean equals(Object o) {
    ...
    ArrowProjectedFragment_cxx_0x508ada88 that = (ArrowProjectedFragment_cxx_0x508ada88) o;
  ...
  public BaseTypedArray<Integer> getEdataArrayAccessor() {
    long ret$ = nativeGetEdataArrayAccessor(address); return (new com.alibaba.graphscope.ds.BaseTypedArray_cxx_0x4f4be6c2(ret$));
  }
  ...
  @CXXValue
  public ProjectedAdjList<Long, Integer> getIncomingAdjList(@CXXReference Vertex<Long> arg0) {
    long ret$ = nativeGetIncomingAdjList(address, com.alibaba.fastffi.CXXValueScope.allocate(com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0x4c794de0.SIZE), ((com.alibaba.fastffi.FFIPointerImpl) arg0).address); return (new com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0x4c794de0(ret$));
  }
  ...
  @CXXValue
  public ProjectedAdjList<Long, Integer> getOutgoingAdjList(@CXXReference Vertex<Long> arg0) {
    long ret$ = nativeGetOutgoingAdjList(address, com.alibaba.fastffi.CXXValueScope.allocate(com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0x4c794de0.SIZE), ((com.alibaba.fastffi.FFIPointerImpl) arg0).address); return (new com.alibaba.graphscope.ds.ProjectedAdjList_cxx_0x4c794de0(ret$));
  }
